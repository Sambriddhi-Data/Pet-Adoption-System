    ...
    try {
        ...
        const result = await sendEmail({
            ...
            message: `
                ...
                <p>Congratulations!! The application you made to ${shelterName} to rehome ${petName} was successful.</p><br/>

                <p>We are thrilled to inform you that your rehome request has been approved! You can now proceed with the next steps in the rehoming process.</p>
                <p>Reach out to ${shelterName} at <span style={{ color: 'blue' }>${shelterPhoneNumber} </span>regarding further steps in the rehoming process.</p>

                <p>To view your request status and get more details about the shelter, please log in to your account and follow the link below:</p>
