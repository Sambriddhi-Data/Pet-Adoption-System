...
import { PawPrint, Calendar, Ruler, MapPin, Heart, Users, Home, ArrowLeft } from 'lucide-react';
import {
    Dialog,
    DialogContent,
    DialogDescription,
    ...
    useEffect(() => {
        ...
        if (id) {
            const fetchPetDetails = async () => {
                try {
                    const response = await axios.get<PetData>(API_ROUTES.getPetById(id))
