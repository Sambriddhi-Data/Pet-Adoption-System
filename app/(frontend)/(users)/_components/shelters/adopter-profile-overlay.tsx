...
const AdopterProfileOverlay: React.FC<AdopterProfileOverlayProps> = ({ request }) => {
    return (
        <div className="p-6 bg-white rounded-lg shadow-lg w-full relative">
            ...
            <div className="flex gap-2 p-2"><Calendar color="green" /><span className="text-gray-800">{new Date(request.createdAt).toLocaleDateString()}</span></div>

            <h2 className="text-xl font-bold">{request.adoptionprofile.user.name}'s Profile</h2>
