...
export function PetCard(){
    return (
        <div className='mt-10 text-center'>
          <div>
            <Card className="flex-col justify-center w-full max-w-md bg-white bg-opacity-85 shadow-lg px-4 ">
              <CardContent>
                <h1>IMAGE</h1>
                <CldImage
                  ...
                  width="24" // Transform the image: auto-crop to square aspect_ratio
                  height="24"
                  alt="Sample"
                  crop={{
                    type: 'auto',
