...
export function PetCard({ name = "Unknown", age = "Unknown", status = "Unknown", address = "Unknown"}) {
  ...
  return (
    <div className='mt-10 cursor-pointer'>
      <Card className="relative w-64 h-80 text-left bg-white bg-opacity-90 shadow-xl rounded-2xl overflow-hidden transition-transform duration-300 hover:scale-105">
