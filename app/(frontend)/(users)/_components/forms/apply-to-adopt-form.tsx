...
import { applyToAdoptSchema, TApplyToAdoptSchema } from "./customer-form-schema";
...
export default function AdoptPetForm() {
    ...
    const form = useForm<TApplyToAdoptSchema>({
    ...
    useEffect(() => {
        if (adopterProfile && user) {
            form.reset({
                ...
                min_age: adopterProfile.adoptionProfile?.min_age || 0,
                ...
                other_information: adopterProfile.adoptionProfile?.other_information || "",
            });
        }
    ...
    async function onsubmit(values: TApplyToAdoptSchema) {
        setPending(true);
        ...
        <main className="m-5">
            <div className="max-w-3xl mx-auto">
                <CardHeader className="flex items-center justify-center">
                    ...
                    <CardDescription>Please fill out this form to apply for pet adoption. This helps shelters learn about the home you’ll provide and ensures the best match for both you and the pet.
                        Your details will help the shelter decide on your application. Thank you for giving a pet a loving home!
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onsubmit)} className="space-y-4">
                            <div className=" flex flex-col space-y-4 max-w-2xl">
                                ...
                                />
                                <p className="text-primary">Please upload at least two images of your home or any outside space to help the shelter visualize the home you are offering the pet. </p>
                                ...
                                {form.watch("other_animals") && form.watch("other_animals") === true && (
                                    <>
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-col">
                                                    <FormLabel>Enter details of other pets such as numbers of pets and their species:</FormLabel>
                                                    <FormControl>
                                                        <Input placeholder="e.g. 2 dogs, 1 cat" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-col">
                                                    <FormLabel>Are the other pets neutered?</FormLabel>
                                                    <FormControl>
                                                        <Combobox
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-col">
                                            <FormLabel>Any other information to support your application?<span style={{ color: 'red' }}> *</span></FormLabel>
                                            <FormControl>
                                                <Textarea placeholder="Any other information..." {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
